...
<div class="col-md-4 col-sm-12 mb-12 padding0" style="text-align:right;">
<a href="{{route('admin.profile')}}"><button class="btn_dachboard"><i class="fa fa-user floatleftincons"></i> View profile</button></a>
...
<div class="col-md-6 col-sm-12 mb-12">
<img src="{{ asset('image/undraw/all_the_data.svg')}}" style="width:200px;height:200px;">
</div>
</div>
</div>
</div>
