...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('public/asset/css/mdb.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('public/asset/css/style.min.css') }}">
...
<div id="carousel-example-1z" class="carousel slide carousel-fade pt-4" data-ride="carousel" style="min-height:600px;">
        ...
        <div class="view" style="background-image: url('https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/8-col/img%282%29.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              <h1 class="mb-4">
                <strong>Welcome in STORE-TEC</strong>
              </h1>

              <p>
                <strong>Best store for women & men</strong>
              </p>
              ...
              <a  href="{{route('store.shop.all')}}" class="btn btn-outline-white btn-lg">
			  SHOP NOW
              </a>
            </div>
            <!-- Content -->
